...
namespace SeguraChain_Desktop_Wallet.InternalForm.Setup
{
    public partial class ClassWalletSetupForm : Form
    {
        ...
        {
           var walletSetupFormLanguageObject = ClassDesktopWalletCommonData.LanguageDatabase.GetLanguageContentObject<ClassWalletSetupFormLanguage>(ClassLanguageEnumType.LANGUAGE_TYPE_WALLET_SETUP_FORM);
