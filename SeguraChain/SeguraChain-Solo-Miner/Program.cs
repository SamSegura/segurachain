...
namespace SeguraChain_Solo_Miner
{
    class Program
    {
        ...
        {
            ClassSoloMinerSettingLoadEnum soloMinerSetting = ClassSoloMinerSettingFunction.LoadSoloMinerSettingFile(selectedPath, out ClassSoloMinerSettingObject soloMinerSettingObject);

            switch (soloMinerSetting)
            {
