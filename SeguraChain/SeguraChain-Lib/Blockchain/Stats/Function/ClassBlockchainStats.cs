...
namespace SeguraChain_Lib.Blockchain.Stats.Function
{
    public class ClassBlockchainStats
    {
        ...
        /// <param name="cancellation"></param>
        /// <returns></returns>
        public static async Task<SortedList<string, ClassBlockTransaction>> GetTransactionListFromBlockHeightTarget(long blockHeight, bool keepAlive, CancellationTokenSource cancellation)
        {
