    ...
    public class ClassMiningPoWaCUtility
    {
        ...
        public static bool ComparePoWaCShare(ClassMiningPoWaCShareObject pocShareObject1, ClassMiningPoWaCShareObject pocShareObject2)
        {
            ...
            if (pocShareObject1.BlockHeight == pocShareObject2.BlockHeight &&
                ...
                pocShareObject1.BlockHash == pocShareObject2.BlockHash)
            {
                return true;
            }
        ...
        {
            if ((IsACorner(p1, p2, p3) && IsACorner(p4, p2, p3))
                || (IsACorner(p1, p2, p4) && IsACorner(p3, p2, p4))
                || (IsACorner(p1, p3, p4) && IsACorner(p2, p3, p4)))
            {
                return true;
            }
