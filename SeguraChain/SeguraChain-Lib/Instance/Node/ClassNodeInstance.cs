...
namespace SeguraChain_Lib.Instance.Node
{
    public class ClassNodeInstance
    {
        ...
        public bool NodeStart(bool fromWallet)
        {
            ...
            if (PeerSettingObject.PeerBlockchainDatabaseSettingObject.DataSetting.EnableEncryptionDatabase)
            {
        ...
        public async Task NodeStop(bool forceClose = false, bool isWallet = false)
        {
            ...
            ClassMemPoolDatabase.SaveMemPoolDatabase(PeerSettingObject.PeerBlockchainDatabaseSettingObject);
            ...
            await ClassBlockchainDatabase.SaveBlockchainDatabase(PeerSettingObject.PeerBlockchainDatabaseSettingObject);
